...
export const authUrl = () => `${SPOTIFY_ACCOUNTS_URL}/authorize?client_id=${CAMPFIRE_SPOTIFY_CLIENT_ID}&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fcallback&scope=user-read-playback-state%20user-modify-playback-state%20user-top-read%20playlist-modify-private%20playlist-modify-public`;
